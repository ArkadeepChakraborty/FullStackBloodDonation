...
//                 <h5 className="card-title fw-semibold mb-4">Home Page</h5>
//                 <p className="mb-0">This is a Home page </p>
//                 </div>
//             </div>
...
//         {stats.bloodGroups && Array.isArray(stats.bloodGroups) ? (
//           stats.bloodGroups.map((bloodGroup) => (
//             <div key={bloodGroup._id} className="stat-card">
//               <h3>{bloodGroup._id}</h3>
//               <p>Count: <strong>{bloodGroup.count}</strong></p>
//             </div>
//           ))
//         ) : (
//           <p className="loading-text">Loading or no data available...</p>
//         )}
